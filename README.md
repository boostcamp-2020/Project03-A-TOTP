...
그래서 2FA는 필요합니다. 만약 비밀번호가 유출된다고 하더라도 내가 가지고 있는 **디바이스**가 없다면, 또는 나의 **지문과 얼굴**이 없다면 로그인할 수 없도록 막는 것입니다. TOTP는 디바이스를 이용한 2FA의 방법 중 하나입니다.


<br>

### TOTP (Time-based One-Time Password)
![totp image](https://user-images.githubusercontent.com/26567846/99750036-0274f080-2b23-11eb-97d0-5d54e7fa5f22.png)
